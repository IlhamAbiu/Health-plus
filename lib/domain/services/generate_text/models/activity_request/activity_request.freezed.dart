...
class _$ActivityRequestImpl implements _ActivityRequest {
  ...
  @override
  String toString() {
    return 'ActivityRequest(height: $height, weight: $weight, body_fat_percentage: $body_fat_percentage, bmi: $bmi, basal_metabolism: $basal_metabolism, tdee: $tdee, avg_calories_burned_walking: $avg_calories_burned_walking, avg_calories_burned_exercise: $avg_calories_burned_exercise, maintenance_calories: $maintenance_calories, weight_loss_calories: $weight_loss_calories, weight_gain_calories: $weight_gain_calories, visceral_fat_index: $visceral_fat_index, age: $age, gender: $gender)';
  }
