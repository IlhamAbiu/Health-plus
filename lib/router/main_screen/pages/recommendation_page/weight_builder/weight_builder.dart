...
import 'weight_cubit.dart';

class WeightBuilder extends StatefulWidget {
  const WeightBuilder({super.key});

  @override
  State<WeightBuilder> createState() => _WeightBuilderState();
}

class _WeightBuilderState extends State<WeightBuilder> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocBuilder<WeightCubit, WeightResponse?>(
