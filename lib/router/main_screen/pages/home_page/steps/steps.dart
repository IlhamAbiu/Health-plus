              ...
              child: FutureBuilder(
                ...
                builder: (context, snapshot) {
                  return Row(
                    ...
                    children: [
                      BlocBuilder<StepsCubit, StepTrendsResponse?>(
                        builder: (context, state) {
                          return RichText(
                            text: TextSpan(
                              text: snapshot.connectionState ==
                                      ConnectionState.done
                                  ? S().steps_to_day_current(
                              ...
                              children: [
                                TextSpan(
                                  text: state?.steps_needed != null
                                      ? '\n/${state?.steps_needed.round()}'
                                      : S().steps_to_day_target(5000),
                                  style: TextStyle(
                                    fontFamily: GoogleFonts.roboto().fontFamily,
                                    fontWeight: FontWeight.bold,
                                    fontSize: 18,
                      ...
                      BlocBuilder<StepsCubit, StepTrendsResponse?>(
                        builder: (context, state) {
                          return Builder(builder: (context) {
                            final percent = state?.steps_needed != null
                                ? snapshot.requireData /
                                    state!.steps_needed.round()
                                : snapshot.requireData / 5000;
                            return Padding(
