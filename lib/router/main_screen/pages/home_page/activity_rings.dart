                      ...
                      child: Stack(
                        ...
                        children: [
                          Center(
                            child: Builder(
                              builder: (context) {
                                final percent = snapshot.requireData[0] / 10000;
                                return SizedBox(
                                  width: 70,
                                  height: 70,
                                  child: Center(
                                    child: CircularPercentIndicator(
                                      ...
                                      progressColor: const Color(0xFF04D563),
                                      backgroundColor: const Color(0xFFCDF7E0),
                          ...
                          Center(
                            child: Builder(
                              builder: (context) {
                                final percent = snapshot.requireData[1] / 200;
                                return SizedBox(
                                  width: 56.3,
                                  height: 56.3,
                                  child: Center(
                                    child: CircularPercentIndicator(
                                      ...
                                      circularStrokeCap:
                                          CircularStrokeCap.round,
                                      progressColor: const Color(0xFF7CB4FE),
                          ...
                          Center(
                            child: Builder(
                              builder: (context) {
                                final percent = snapshot.requireData[2] / 500;
                                return SizedBox(
                                  width: 42.6,
                                  height: 42.6,
                                  child: Center(
                                    child: CircularPercentIndicator(
                                      ...
                                      circularStrokeCap:
                                          CircularStrokeCap.round,
                                      progressColor: const Color(0xFFFC6FB3),
                                      backgroundColor: const Color(0xFFFCDAEA),
                                      widgetIndicator: Center(
                                        child: Container(
                                          margin:
                                              const EdgeInsets.only(right: 5),
